...
```bash
oc create -f https://raw.githubusercontent.com/arrow-martinpersson/cloud-pak-deployer-aic/main/resources/build.yaml
```
...
```bash
oc create -f https://raw.githubusercontent.com/arrow-martinpersson/cloud-pak-deployer-aic/main/resources/resources.yaml
```
